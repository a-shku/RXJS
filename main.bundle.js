...
// Module
exports.push([module.i, "input {\n    width: 60%;\n    height: 25px;\n}\ninput.loading {\n    background-size: 25px 25px;\n    background: #ffffff url(\"http://loadinggif.com/images/image-selection/3.gif\") no-repeat right center;\n}", ""]);
...
var RESULT_LENGTH = 10;
console.info('Run');
var input = document.getElementById('searchString');
var output = document.getElementById('results');
var enteredValues$ = rxjs_1.fromEvent(input, 'input');
function getRepositories(query) {
    return __awaiter(this, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://api.github.com/search/repositories?q=" + query)];
                case 1:
                    res = _a.sent();
...
enteredValues$
    ...
    output.innerHTML = '';
    var inputValue = change.target.value;
    getRepositories(inputValue).then(function (list) {
